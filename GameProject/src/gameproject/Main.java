	...
	public Main() {
		...
		try {
			splashScreen.setContentPane(new JLabel(
					new ImageIcon(ImageIO.read(new File("8-Ball-Pool/8 Ball Pool/resource/Images/8 Ball Pool SplashScreen.jpg"))
		...
		try {
			bgMusic.loadSound("8-Ball-Pool/8 Ball Pool/resource/Music/This City Prod. David Wud.wav");
		...
		try {
			mainScreen.setContentPane(new JLabel(
					new ImageIcon(ImageIO.read(new File("8-Ball-Pool/8 Ball Pool/resource/Images/main menu background.jpg"))
							.getScaledInstance((int) WIDTH, (int) HEIGHT, Image.SCALE_SMOOTH))));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		JLabel logoLabel;
		try {
			logoLabel = new JLabel(new ImageIcon(ImageIO.read((new File("8-Ball-Pool/8 Ball Pool/resource/Images/logo.png")))
		...
		loadButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				startBalls();
				content.loadGame("8-Ball-Pool/8 Ball Pool/resource/saveFile.txt");
			}
		});
